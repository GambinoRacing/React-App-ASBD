    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-12">
            <br />
            <p>Значение на водата за явленията и процесите, развиващи се на земята:</p>
        ...
        <div className="row">
          <div className="col-md-6">
            <br/>
            <br/>
            <p>Сектор "Хидрология" извършва услуги със следната режимна информация :</p>
            <ul>
